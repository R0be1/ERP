export const employees = [
  {
    ...
    address: { country: 'Ethiopia', region: 'addis-ababa', city: 'Addis Ababa', subcity: 'Bole', woreda: '01', kebele: '02', houseNo: '123' },
    emergencyContacts: [{ name: 'John Johnson', relationship: 'Spouse', phone: '098-765-4321' }],
    ...
    internalExperience: [{ title: 'Software Engineer', department: 'Engineering', startDate: '2020-01-15', endDate: '', responsibilities: 'Developing features' }],
    externalExperience: [{ company: 'Tech Corp', title: 'Junior Developer', startDate: '2018-06-01', endDate: '2019-12-31', responsibilities: 'Bug fixing' }],
